...
from .db import engine, Base, ensure_scoring_columns, ensure_bracket_columns, ensure_prediction_id_column, ensure_approval_status_column
...
async def lifespan(app: FastAPI):
    ...
    await ensure_approval_status_column()
    yield
