...
GLOBAL_NEWS_CACHE_TTL_SECONDS = 30 * 60
...
def get_news_yfinance(
    ...
    try:
        return get_cached_text(
            ...
            max_age_seconds=TICKER_NEWS_CACHE_TTL_SECONDS,
            fetcher=_fetch,
        )
...
def get_global_news_yfinance(
    ...
    try:
        return get_cached_text(
            prefix="global_news",
            payload={"curr_date": curr_date, "look_back_days": look_back_days, "limit": limit},
            max_age_seconds=GLOBAL_NEWS_CACHE_TTL_SECONDS,
            fetcher=_fetch,
        )
    except Exception as e:
