...
class MessageBuffer:
    ...
    def _update_final_report(self):
        ...
        analyst_sections = ["market_report", "technical_report", "sentiment_report", "news_report", "fundamentals_report"]
...
def save_report_to_disk(final_state, ticker: str, save_path: Path):
    ...
    if final_state.get("technical_report"):
        analysts_dir.mkdir(exist_ok=True)
        (analysts_dir / "technical.md").write_text(final_state["technical_report"])
...
ANALYST_ORDER = ["market", "technical", "social", "news", "fundamentals"]
ANALYST_AGENT_NAMES = {
    "market": "Market Analyst",
    "technical": "Technical Analyst",
    "social": "Social Analyst",
